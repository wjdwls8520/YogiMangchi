 ...
 *
 * <ul>
 *   <li>{@link #PHASE_1_SNAPSHOT}            — 1단계: 가격 스냅샷 캡처 단계</li>
 *   <li>{@link #PHASE_2A_POSITION_CLOSE}     — 2단계: 포지션 일괄 청산 단계 (가장 무거운 단계)</li>
 *   <li>{@link #PHASE_2B_WALLET_DEACTIVATE}  — 3단계: 지갑 일괄 비활성화 단계</li>
 *   <li>{@link #PHASE_2C_AGGREGATE}          — 4단계: 참가자 최종 결과 확정 단계</li>
 *   <li>{@link #PHASE_3_MARK_SETTLED}        — 5단계: 정산 완료 마킹 단계</li>
 * </ul>
 *
