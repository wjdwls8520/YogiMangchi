        ...
        <table className="w-full text-[11px] whitespace-nowrap">
          ...
          <tbody>
            {processedCoins.map((coin) => {
              ...
              const isSpotMode = !isFutures;
              const buyColor = isFutures ? "text-trade-long" : (isSpotMode ? "text-[#fb2c36]" : "text-emerald-400");
              const sellColor = isFutures ? "text-trade-short" : (isSpotMode ? "text-[#0058FF]" : "text-rose-400");
