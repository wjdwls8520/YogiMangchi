...
export default function FolderTabs({
  ...
  return (
    <div className="w-full">
      {/* 1. 탭 타이틀 영역 (왼쪽 상단 정렬) */}
      <div className="flex items-end gap-0.5 h-12 rounded-t-md bg-gray-900">
        {tabs.map((tab) => {
                ...
                ${
                  isActive
                    ...
                    : // [비활성 상태] 바디 뒤로 숨어있는 느낌을 줍니다.
                      "z-0 h-10 text-gray-100 bg-gray-800 border-1 border-gray-800 border-b-transparent hover:bg-gray-900"
                }
              `}
            >
              {tab.label}
      ...
      {/* 2. 바디 영역 */}
      <div className="relative z-10 w-full min-h-[300px] p-8 bg-white border-1 border-gray-200 rounded-xl rounded-tl-none rounded-tr-none">
