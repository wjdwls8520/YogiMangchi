...
export default function FolderTabs({
  ...
  return (
    <div className="w-full">
                ...
                ${
                  isActive
                    ...
                    : // [비활성 상태] 바디 뒤로 숨어있는 느낌을 줍니다.
                      "z-0 h-10 text-gray-400 dark:text-gray-500 bg-gray-800 dark:bg-zinc-900 border border-gray-800 dark:border-zinc-800 border-b-transparent hover:bg-gray-200 dark:hover:bg-zinc-800"
                }
              `}
            >
              {tab.label}
      ...
      {/* 2. 바디 영역 */}
      <div className="relative z-10 w-full min-h-[300px] p-4 sm:p-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl rounded-tl-none rounded-tr-none transition-colors">
