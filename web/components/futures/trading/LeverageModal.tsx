          ...
          <div className="mb-6 flex gap-2 rounded-lg bg-slate-100 p-1">
            <button
              ...
              className={`flex-1 rounded-md py-2 text-xs font-black transition-all ${
                activeSide === "LONG" ? "bg-[#2EBD85] text-white shadow-lg" : "text-gray-500 hover:text-gray-300"
              }`}
            >
              LONG
            </button>
            <button
              ...
              className={`flex-1 rounded-md py-2 text-xs font-black transition-all ${
                activeSide === "SHORT" ? "bg-[#F6465D] text-white shadow-lg" : "text-gray-500 hover:text-gray-300"
              }`}
            >
              SHORT
            </button>
