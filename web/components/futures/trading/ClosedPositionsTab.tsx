        ...
        <table className="w-full min-w-[1200px] border-separate border-spacing-0">
          <thead className="sticky top-0 z-10 bg-[#161A1E]">
            <tr className="text-[11px] font-bold uppercase tracking-wide text-gray-500">
              <th className="border-b border-white/5 px-4 py-3 text-left">자산</th>
              <th className="border-b border-white/5 px-4 py-3 text-center">방향</th>
              <th className="border-b border-white/5 px-4 py-3 text-right">체결수량</th>
              <th className="border-b border-white/5 px-4 py-3 text-right">진입가</th>
              <th className="border-b border-white/5 px-4 py-3 text-right">청산가</th>
              <th className="border-b border-white/5 px-4 py-3 text-right">실현손익</th>
              <th className="border-b border-white/5 px-4 py-3 text-right">ROE%</th>
              <th className="border-b border-white/5 px-4 py-3 text-right">수수료</th>
              <th className="border-b border-white/5 px-4 py-3 text-center">종료일시</th>
            </tr>
          </thead>
          <tbody>
            {items.map((p) => {
              ...
              return (
                <tr key={p.positionId} className="border-b border-white/5 last:border-b-0 hover:bg-white/[0.02]">
                  <td className="px-4 py-4 whitespace-nowrap">
                    <p className="text-sm font-black text-white">{p.symbol}</p>
                    <p className="text-[10px] font-medium text-gray-500">Isolated {p.leverage}x</p>
                  </td>
