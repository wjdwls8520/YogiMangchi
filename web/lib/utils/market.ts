...
export const getMarketSymbolsApiUrl = (marketType: MarketType) => {
  return marketType === "spot"
    ? `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8080'}/api/v1/market/spot/symbols`
    : `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8080'}/api/v1/market/futures/symbols`;
};
