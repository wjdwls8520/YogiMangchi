...
//                   className={`flex flex-col items-center justify-center rounded-xl border p-4 transition-all focus:outline-none ${selectedStyle === style.id
...
//               className={`flex w-full justify-center rounded-xl px-5 py-4 text-base font-bold text-white transition-all ${isFormValid
