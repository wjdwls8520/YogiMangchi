...
export default function MainPage() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        const result = await getPosts({ size: 4 });
        if (result && result.content) {
          setCommunityPosts(result.content);
        }
      } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 space-y-28">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 rounded-3xl bg-white border border-gray-100 shadow-sm p-8 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 font-semibold">입력창에 입력하시면 실시간 시장 환율로 즉시 양방향 연동됩니다.</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-black text-gray-500 tracking-wider">원화 입력 (KRW)</label>
                ...
                {/* YD Input */}
                <div className="space-y-2">
                  <label className="text-xs font-black text-gray-500 tracking-wider">요기달러 입력 (YD)</label>
                  <div className="relative">
                    <input
                      type="text"
            ...
            <div className="mt-6 md:mt-0 text-xs text-gray-400 font-medium bg-gray-50 p-3.5 rounded-2xl border border-gray-50 flex items-center justify-between">
        ...
        <section className="space-y-6">
          <div className="flex items-end justify-between px-2">
            ...
            <Link href="/trading" className="flex items-center gap-1 text-xs font-black text-gray-400 hover:text-[#0058FF] transition-colors">
              <span>거래소 전체보기</span>
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-start">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400 font-bold uppercase">{item.ticker.symbol}</p>
                      </div>
                    </div>

                    <span className="text-[11px] font-black text-gray-400 group-hover:text-gray-900 flex items-center gap-0.5 transition-colors">
                      거래하기
                  ...
                  <div className="flex items-end justify-between border-t border-gray-50 pt-4 mt-2">
                    ...
                    {item.ticker.isLoading ? (
                      <span className="text-xs px-2 py-0.5 rounded bg-gray-50 text-gray-400 font-bold">-</span>
                    ) : (
                      <span
                        className={cn(
                          "text-xs font-black px-2 py-0.5 rounded-lg flex items-center gap-0.5",
        ...
        <section className="rounded-3xl bg-[#0F172A] text-white p-8 sm:p-12 relative overflow-hidden shadow-xl border border-gray-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12 relative z-10">
            ...
            <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-800 p-6 rounded-2xl flex flex-col justify-between h-48 hover:border-blue-500/40 hover:bg-gray-800/60 transition-all group">
              <div>
                <span className="text-[11px] font-black text-blue-500 uppercase tracking-widest block mb-4">Step 01</span>
              ...
              <span className="text-[11px] text-gray-500 font-bold group-hover:text-blue-400 transition-colors">기초 신뢰 확보</span>
            </div>

            {/* Step 2 */}
            <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-800 p-6 rounded-2xl flex flex-col justify-between h-48 hover:border-blue-500/40 hover:bg-gray-800/60 transition-all group">
              <div>
                <span className="text-[11px] font-black text-blue-500 uppercase tracking-widest block mb-4">Step 02</span>
                <h4 className="text-sm font-black text-gray-100 flex items-center gap-2 mb-2">
              ...
              <span className="text-[11px] text-gray-500 font-bold group-hover:text-blue-400 transition-colors">위험 관리 훈련</span>
            </div>

            {/* Step 3 */}
            <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-800 p-6 rounded-2xl flex flex-col justify-between h-48 hover:border-blue-500/40 hover:bg-gray-800/60 transition-all group">
              <div>
                <span className="text-[11px] font-black text-emerald-500 uppercase tracking-widest block mb-4">Step 03</span>
              ...
              <span className="text-[11px] text-emerald-500 font-bold group-hover:text-emerald-400 transition-colors">현물 지갑 Active</span>
            </div>

            {/* Step 4 */}
            <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-800 p-6 rounded-2xl flex flex-col justify-between h-48 hover:border-blue-500/40 hover:bg-gray-800/60 transition-all group">
              <div>
                <span className="text-[11px] font-black text-blue-500 uppercase tracking-widest block mb-4">Step 04</span>
                <h4 className="text-sm font-black text-gray-100 flex items-center gap-2 mb-2">
              ...
              <span className="text-[11px] text-gray-500 font-bold group-hover:text-blue-400 transition-colors">무제한 수익 도전</span>
            </div>
        ...
        <section className="space-y-6">
          <div className="flex items-end justify-between px-2">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl font-black text-gray-900">최신 커뮤니티 게시글</h3>
            </div>
            <Link href="/community/all" className="flex items-center gap-1 text-xs font-black text-gray-400 hover:text-[#0058FF] transition-colors">
              <span>커뮤니티 전체보기</span>
              <ChevronRight size={12} />
            </Link>
          </div>
              ...
              communityPosts.map((post) => (
                ...
                >
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-[11px] font-black px-2.5 py-1 rounded-full uppercase tracking-wider bg-blue-50 text-blue-600">
                        커뮤니티
                      </span>
                      <span className="text-[11px] text-gray-400 font-bold">{formatTime(post.createdAt)}</span>
                    </div>

                    <h4 className="text-sm sm:text-base font-black text-gray-800 leading-snug group-hover:text-blue-600 transition-colors duration-200 line-clamp-2">
                      {post.title}
                    </h4>
                  ...
                  <div className="flex items-center justify-between border-t border-gray-50 pt-4">
                    <span className="text-[11px] text-gray-500 font-bold">작성자: {post.nickname}</span>
                    <span className="text-[11px] text-blue-600 font-black flex items-center gap-1 group-hover:underline cursor-pointer">
                      게시글 보기
